...
export default function Simulador() {
  ...
  const simular = () => {
    ...
    setResultado(`${mensaje}. Podrían cambiar otras variables económicas. (Simulación en desarrollo)`);

    const nuevaAccion = { accion: mensaje, fecha: new Date().toISOString().split('T')[0] };
